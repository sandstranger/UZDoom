...
CUSTOM_CVAR(Int, gl_pipeline_depth, 4, CVAR_ARCHIVE | CVAR_GLOBALCONFIG | CVAR_NOINITCALL)
{
	if (self < 0)
	{
		self = 0;
...
#ifdef __ANDROID__
CUSTOM_CVAR(Int, vid_maxfps, 200, CVAR_ARCHIVE | CVAR_GLOBALCONFIG) // Very high FPS can cause controls to go strange
#else
