...
namespace ShaderInputsOutputs
{
	...
	TArray<ShaderIOEntry> ShaderFields
	{
		...
		// TODO don't actually pass unused vertex attrs for simple shaders
		{ShaderPosition::VInput, {UniformType::Vec4, "", "aVertex2"}, 0, 0}, // 0, Simple},
		{ShaderPosition::VInput, {UniformType::Vec4, "", "aNormal"}, 0, 0}, // 0, Simple},
		{ShaderPosition::VInput, {UniformType::Vec4, "", "aNormal2"}, 0, 0}, // 0, Simple},
		{ShaderPosition::VInput, {UniformType::Vec3, "", "aLightmap"}, 0, 0}, // 0, Simple},
		{ShaderPosition::VInput, {UniformType::Vec4, "", "aBoneWeight"}, 0, 0}, // 0, Simple},
		{ShaderPosition::VInput, {UniformType::UVec4, "", "aBoneSelector"}, 0, 0}, // 0, Simple},
...
#ifdef ANDROID //karin: convert GLSL code to 300 es on OpenGLES
